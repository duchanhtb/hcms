...
class Image {
    ...
    // HanhND create this function
    function createThumb($thumb_path, $width, $height, $crop = 'crop') {
        $this->resize($width, $height, $crop);
        $thumb_path = pathinfo($thumb_path);
        $this->save($thumb_path['filename'], $thumb_path['dirname'], $thumb_path['extension']);
    }
