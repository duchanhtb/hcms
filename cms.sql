...
--
-- Host: localhost
-- Generation Time: Mar 16, 2016 at 12:53 PM
...
(1, 'admin', '96e51e0a813cf3873ac8e6a925387e75', 'hanhcoltech@gmail.com', 3, '2016-02-29 09:34:33', '2016-03-16 09:03:01', '127.0.0.1'),
...
CREATE TABLE IF NOT EXISTS `m_language` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Bảng lưu thông tin ngôn ngữ' AUTO_INCREMENT=293 ;
...
CREATE TABLE IF NOT EXISTS `m_page` (
  ...
  KEY `layout` (`layout`),
  KEY `parent` (`parent`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Bảng chính của CMS, lưu các thông tin về page, module' AUTO_INCREMENT=12 ;
